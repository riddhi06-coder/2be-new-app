        ...
        <div class="row">
          <div class="col-12">     
            <div class="login-card login-dark">
              <div>
              <div style="padding: 1px;"><a class="logo" href="#"><img class="img-fluid for-dark" src="{{ asset('admin/assets/images/logo/logo.webp') }}" alt="looginpage" style="max-width: 30% !important;"><img class="img-fluid for-light" src="{{ asset('admin/assets/images/logo/logo.webp') }}" alt="looginpage" style="max-width: 30% !important;"></a></div>
              <br>  
