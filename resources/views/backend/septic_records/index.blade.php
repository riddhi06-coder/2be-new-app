            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header pb-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <div>
                            <h5 class="mb-1 fw-semibold">Septic Inspection Records</h5>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0 small">
                                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                                    <li class="breadcrumb-item active">Septic Records</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="filter-card">
                            <form method="GET" action="{{ route('septic-records.index') }}" class="row g-2 align-items-end">
                                <div class="col-auto">
                                ...
                                <div class="col-auto d-flex gap-2">
                                    ...
                                    <a href="{{ route('septic-records.index') }}" class="btn btn-sm btn-secondary px-3">Reset</a>
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="septic-table" class="display table table-hover table-bordered w-100" style="width:100%">
                                <thead>
                                    <tr>
                                        <th style="width:4%;">#</th>
                                ...
                                <tbody>
                                    @foreach($records as $index => $record)
                                        <tr>
                                            ...
                                            <td>{{ $record->inserted_at ? \Carbon\Carbon::parse($record->inserted_at)->format('d/m/Y H:i') : '—' }}</td>
                                            <td>
                                                <div class="dt-action-btns">
                                                    <a href="{{ route('septic-records.edit', $record->id) }}"
                                                       class="btn btn-sm btn-primary" title="Edit Record">
                                                        <i class="fa-solid fa-pen-to-square"></i> Edit
                                                    </a>
                                                    <!-- <a href="{{ route('septic-records.pdf', $record->id) }}"
                                                    ...
                                                    <form method="POST" action="{{ route('septic-records.destroy', $record->id) }}"
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom">
                <h5 class="modal-title fw-semibold">
                    <i class="fa-solid fa-envelope me-2 text-info"></i>Send Septic Inspection Report
                </h5>
...
$(document).ready(function () {
    $('#septic-table').DataTable({
        ...
        columnDefs: [
            ...
            { targets: 2, width: '18%' },
            { targets: 3, width: '24%' },
            { targets: 4, orderable: false, className: 'text-center', width: '8%'  },
            { targets: 5, width: '14%' },
            { targets: 6, orderable: false, className: 'text-center', width: '20%' },
        ],
        language: {
            ...
            emptyTable     : 'No septic records available',
