            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Septic Records</li>
                    </ol>
                </nav>
            </div>
                            ...
                            <table id="septic-table" class="display table table-hover table-bordered w-100" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:20%;">Inspector / Company</th>
                                        <th style="width:24%;">Site Address</th>
...
$.fn.dataTable.ext.search.push(function (settings, data, dataIndex) {
    if (settings.nTable.id !== 'septic-table') return true;
...
$(document).ready(function () {
    septicTable = $('#septic-table').DataTable({
        autoWidth : false,
        pageLength: 25,
        order     : [[1, 'desc']],
        columnDefs: [
            ...
            { targets: 5, width: '14%' },
            { targets: 6, orderable: false, className: 'text-center', width: '14%' },
        ],
        language: {
    ...
    ['filter_from_date', 'filter_to_date', 'filter_status'].forEach(function (id) {
        document.getElementById(id).addEventListener('change', function () { septicTable.draw(); });
    });
});
